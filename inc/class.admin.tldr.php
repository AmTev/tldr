...
class TLDR_Plugin
{
    ...
    public function api_key_field_html()
    {
        ...
        <div style="position: relative; display: inline-block;">
            <input type="password" id="tldr_key" name="tldr_key" value="<?php echo $value; ?>" class="regular-text" style="padding-right: 30px;" />
            <span id="toggle-tldr-key" class="dashicons dashicons-visibility" style="position: absolute; right: 10px; top: 50%; transform: translateY(-50%); cursor: pointer;"></span>
        </div>
        <script>
    ...
    public function settings_tldr_page_html()
    {
        ...
        <div class="wrap">
            ...
            <h2 class="nav-tab-wrapper">
                <a href="?page=tldr-settings&tab=settings" class="nav-tab <?php echo $active_tab == 'settings' ? 'nav-tab-active' : ''; ?>">Settings</a>
                <a href="?page=tldr-settings&tab=documentation" class="nav-tab <?php echo $active_tab == 'documentation' ? 'nav-tab-active' : ''; ?>">Docs</a>
            </h2>
  ...
  <ol>
    <li>
      ...
      👉 <a href="https://platform.turboline.ai/signup" target="_blank" rel="noopener noreferrer"><strong>Get API Keys</strong></a>
    </li>
    <li>
    ...
    <li>
      ...
      👉 <a href="https://platform.turboline.ai/signin" target="_blank" rel="noopener noreferrer"><strong>Sign In</strong></a>
    </li>
    <li>
    ...
    <li>
      ...
      <ul>
        <li>After subscribing, your <strong>Primary Key</strong> and <strong>Secondary Key</strong> will appear.</li>
      </ul>
    </li>
    <li>
